...
public interface BookingRepository extends JpaRepository<Booking, Integer> {
    @Query("SELECT b FROM Booking b WHERE b.bookingDate = :bookingDate AND b.court.courtID = :courtID")
    List<Booking> findByBookingDate(@Param("bookingDate") LocalDate bookingDate, @Param("courtID") int courtID);
